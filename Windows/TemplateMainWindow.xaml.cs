    ...
    public partial class TemplateMainWindow : Window
    {
        ...
        private void BuildPanels()
        {
            ...
            for (int i = 0; i < panelCount; i++)
            {
                ...
                // If this is the chosen tree panel, add the specialized TreeViewControl
                if (treePanelIndex == i)
                {
                    // For leftmost panel use the TreeViewControl; for others, you could reuse it as well
                    var nav = new TreeViewControl();
